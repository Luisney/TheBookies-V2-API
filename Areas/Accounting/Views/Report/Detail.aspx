<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site2.Master" Inherits="System.Web.Mvc.ViewPage<Gambling.Models.ViewModels.Accounting.ReportViewModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="detailDialog">
        <img class="loader" alt="Cargando..." src="<%= Html.GetImageURL("loading-Horizontal.gif") %>" />
