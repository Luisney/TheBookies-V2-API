...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%= Html.Encode( "Limites por Limites de Venta - Listado de Perfiles de Limites de Venta" )%>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <%= Html.Encode( "Limites de Venta - Listado de Perfiles de Limites de Venta" )%>
    </h2>
    ...
    <div class="twoColumnsSmall">
        ...
        <div id="rightColumnSmall" class="twoColumnsSmall-right">
            <img id="rightColumnLoader" alt="Cargando..." src="<%= Html.GetImageURL("loading-Horizontal.gif")%>" style="display:none;"/>
