...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <input id="autoRefreshCheckbox" type="checkbox" title="Auto refrescar" />Auto-refrescar
    resultados
    <br />
    <br />
    ...
    <div id="voidTicketDialog" title="Anular Ticket">
    ...
    <div id="payTicketDialog" title="Pagar Ticket">
