...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset>
        ...
        <p>
            <%= this.TextBox( PageModel =>  PageModel.Maximum ).Label( "Valor máximo por ticket:" )%>
        ...
        <p>
            <%= this.TextBox( PageModel =>  PageModel.Lottos ).Label( "Cantidad de Loterías:" )%>
            <%= this.ValidationMessage( PageModel =>  PageModel.Lottos )%>
        </p>
        <p>
            <%= this.TextBox( PageModel => PageModel.DigitNumbers ).Label("Digitos por premio:") %>
