...
<asp:Content ID="registerContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="tabs">
        ...
        <fieldset>
            ...
            <p>
                ...
                <img id="resetPasswordLoader" src="/Content/images/ajax-loader-small.gif" alt="Esperando ..." />
                <span id="generatedPasswordLabel">Nueva contraseña: </span><span id="generatedPasswordText">
                </span><a id="changePasswordLink"><span>[Cambiar contraseña]</span></a>
            </p>
            <p>
            ...
            <p>
                <%= this.TextBox( U => U.Name ).Disabled(true).Label( "Nombre:" )%>
        ...
        <div id="user-retentions">
            ...
            <fieldset>
                <legend>
                    <%= Html.Encode("Seleccione los Centros de Acopio adicionales para consulta") %></legend>
    ...
    <div id="changePassword-dialog" title="Cambiar Contraseña">
