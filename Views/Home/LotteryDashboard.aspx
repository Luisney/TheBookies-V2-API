...
<asp:Content ID="indexContent" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width:100%"><tr><td><h2>Monitoreo de Números</h2><td><td style="width:300px;text-align:right">Ordenado por: 
	<select id="OrderBy" onchange="refreshMonitoreo()">
	<option value="0">Números</option>
<option value="1">Jugadas</option>
<option value="2">Venta Bruta</option>
<option value="3">Números Descendente</option>
<option value="4">Jugadas Descendente</option>
<option value="5" selected="selected">Venta Bruta Descendente</option>
	</select>
