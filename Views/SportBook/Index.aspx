...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        ...
        <a class="button" id="copy-btn"><span>Copiar Limites de Tipos de Ticket</span></a>
    </p>
    <div id="copy-dialog" title="Copiar Limites por Tipo de Ticket">
        <p>
            Desde la banca:<br />
